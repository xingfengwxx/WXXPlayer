...
import com.wangxingxing.wxxplayer.widget.PlayButtonView;
...
//        SkinManager.getInstance().updateSkin(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_search:
                break;
            case R.id.tv_home_tab1:
                viewPager.setCurrentItem(0);
                break;
            case R.id.tv_home_tab2:
                viewPager.setCurrentItem(1);
                break;
            case R.id.tv_home_tab3:
                viewPager.setCurrentItem(2);
                break;
            case R.id.tv_home_tab4:
                viewPager.setCurrentItem(3);
                break;
            case R.id.tv_setting:
                break;
            case R.id.fl_play_pause:
                if (isPlaying) {
                    isPlaying = false;
